...
"""
    ...
    def Draw(self):
        ...
        if labels is None or len(labels) == 0:
            ...
            if type(txt) != str:
                txt= str(txt)
        # MS 2to3 port, this creates array of '<Ux' where x is the number
        # of characters in the labels. Such an arrays cannot be passed to
        # glf.glfDrawLabels() while the list self.labels works
