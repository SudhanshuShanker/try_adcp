...
"""
    ...
    def getVisibleVertices(self, picking=False):
        ...
        if picking and self.pickingVertices is not None:
            return self.pickingVertices, list(range(len(self.pickingVertices)))
        else:
            return self.vertexSet.vertices.array, list(range(len(self.vertexSet)))
...
##      return center/len(allObj)
    ...
    def ObjSubTreeBB(self, obj, camera=None):
        ...
        if camera in obj.hiddenInCamera:
            return
