...
def test7():
    ...
    assert data['covalentLigandAtomIndices'] is None
    assert data['wMapWeight'] == 0.6
    assert set(data["mapTypes"]) == set(['C', 'GA', 'Fe', 'A', 'e', 'd', 'S', 'Q', 'F', 'SA', 'G', 'P', 'Mg', 'Cl', 'Zn', 'OA', 'NS', 'Ca', 'Br', 'Mn', 'OS', 'NA', 'J', 'I', 'HS', 'HD', 'H', 'Z', 'N', 'W'])
...
def test8():
    ...
    for i in range(3):
        ...
        assert set(data["mapTypes"]) == set(['C', 'A', 'e', 'd', 'OA', 'Br', 'NA', 'HD', 'N', 'W'])
