...
"""
    ...
    def get(self, residueName ):
        ...
        if residueName in self.angleDef and \
               residueName in self.angleList:
            ...
            print(list(self.angleDef.keys()), 'are defined')
            print(list(self.angleDef.keys()), 'angles are loaded ')
            resListStr = ""
            for key in list(self.angleDef.keys()):
                resListStr += key + ", "
