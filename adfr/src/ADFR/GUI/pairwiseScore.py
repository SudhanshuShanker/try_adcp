...
from ADFRcc.adfr import AtomSet, AtomSetStatic, PairwiseScorer, Parameters
...
class PairwiseScoreTable(QtGui.QWidget):
    ...
    def setScorer(self, scorer, atoms1, atoms2):
        ...
        self._atomSet1 = scorer.getAtomSet1().atomSetStatic
        self._atomSet2 = scorer.getAtomSet1().atomSetStatic
        self._atoms1 = atoms1
        self._atoms2 = atoms2
    ...
    def getPairs(self):
        ...
        return list(zip(pairs[0], pairs[1]))
