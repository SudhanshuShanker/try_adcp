...
class TestViewer(unittest.TestCase):
    ...
    def test_AddObject(self):
        ...
        lcoords = [[[17.0, 14.0, 4.0], [17.0, 13.0, 4.0], [16.0, 13.0, 5.0],
                   [15.0, 14.0, 6.0], [18.0, 13.0, 5.0], [19.0, 13.0, 4.0],
                   [18.0, 12.0, 6.0], [15.0, 12.0, 5.0], [14.0,11.0, 6.0],
                   [14.0, 11.0, 7.0], [15.0, 10.0, 7.0], [13.0, 11.0, 5.0],
                   [13.0, 9.0, 5.0], [12.0, 11.0, 4.0], [13.0, 11.0, 8.0],
                   [14.0, 11.0, 10.0], [12.0, 10.0, 10.0], [11.0, 11.0, 10.0],
                   [14.0, 12.0, 11.0], [16.0, 12.0, 10.0], [12.0, 9.0, 11.0],
                   [11.0, 9.0, 11.0]]]
        l = Polylines("bonded", vertices=lcoords,  visible=1,
                      pickableVertices=1, lineWidth=3,
                      inheritMaterial=0, inheritLineWidth=0)
        # nobnds : Non Bonded atoms are represented by Points
        pcoords = [[11.0, 9.0, 13.0], [12.0, 8.0, 13.0], [10.0, 8.0, 11.0],
                   [10.0, 8.0, 9.0], [10.0, 9.0, 14.0], [9.0, 9.0, 15.0],
                   [9.0, 8.0, 16.0], [9.0, 8.0, 17.0], [8.0, 10.0, 15.0],
                   [7.0, 10.0, 14.0], [8.0, 10.0, 13.0]]
        p = Points( "nobnds", shape=(0,3), 
                    pointWidth=6, visible=1,vertices = pcoords,
                    inheritMaterial=0)
        ...
        # lines: Bonded atoms are represented by IndexedPolyLines
        l2coords = [[[18.0, 14.0, 4.0], [18.0, 13.0, 4.0], [17.0, 13.0, 5.0],
                   [16.0, 14.0, 6.0], [19.0, 13.0, 5.0], [20.0, 13.0, 4.0],
                   [19.0, 12.0, 6.0], [16.0, 12.0, 5.0], [15.0,11.0, 6.0],
                   [15.0, 11.0, 7.0], [16.0, 10.0, 7.0], [14.0, 11.0, 5.0],
                   [14.0, 9.0, 5.0], [13.0, 11.0, 4.0], [14.0, 11.0, 8.0],
                   [15.0, 11.0, 10.0], [13.0, 10.0, 10.0], [12.0, 11.0, 10.0],
                   [15.0, 12.0, 11.0], [17.0, 12.0, 10.0], [13.0, 9.0, 11.0],
                   [12.0, 9.0, 11.0]]]
        l2 = Polylines("bonded", vertices=l2coords,  visible=1,
                       pickableVertices=1, lineWidth=3,
                       inheritMaterial=0, inheritLineWidth=0)
        # nobnds : Non Bonded atoms are represented by Points
        p2coords = [[12.0, 9.0, 13.0], [13.0, 8.0, 13.0], [11.0, 8.0, 11.0],
                   [11.0, 8.0, 9.0], [11.0, 9.0, 14.0], [10.0, 9.0, 15.0],
                   [10.0, 8.0, 16.0], [10.0, 8.0, 17.0], [9.0, 10.0, 15.0],
                   [8.0, 10.0, 14.0], [9.0, 10.0, 13.0]]
        p2 = Points( "nobnds", shape=(0,3), 
                    pointWidth=6, visible=1,vertices = p2coords,
                    inheritMaterial=0)
        # bondorder : Bond Order are represented by Indexed PolyLines
        b2 = Polylines('bondorder', visible=1, lineWidth=3,
                              inheritMaterial=0)
    ...
    def test_AddObjectWhenExistsObjectWithSameName(self):
        ...
        raise RuntimeError('second geom with same name should not be \
