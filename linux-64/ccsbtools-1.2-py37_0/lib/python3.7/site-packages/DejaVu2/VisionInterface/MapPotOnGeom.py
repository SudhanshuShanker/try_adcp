...
class MapPotOnGeom(MacroNode):
    ...
    def afterAddingToNetwork(self):
        ...
        try:
            ...
            getSurfaceVFN_3.inputPortByName['geometry'].configure(*(), **{'color': 'red', 'cast': True, 'shape': 'rect'})
            getSurfaceVFN_3.outputPortByName['geom'].configure(*(), **{'color': 'red', 'shape': 'rect'})
            getSurfaceVFN_3.outputPortByName['vertices'].configure(*(), **{'color': 'green', 'shape': 'rect'})
            getSurfaceVFN_3.outputPortByName['faces'].configure(*(), **{'color': 'purple', 'shape': 'rect'})
            getSurfaceVFN_3.outputPortByName['normals'].configure(*(), **{'color': 'blue', 'shape': 'rect'})
        except:
        ...
        try:
            ...
            mul_4.inputPortByName['data1'].configure(*(), **{'datatype': 'normals3D', 'cast': True, 'shape': 'rect', 'color': 'blue'})
            mul_4.inputPortByName['data2'].configure(*(), **{'datatype': 'float', 'cast': True, 'shape': 'circle', 'color': 'green'})
            mul_4.inputPortByName['operation'].configure(*(), **{'color': 'white', 'cast': True, 'shape': 'diamond'})
            mul_4.inputPortByName['applyToElements'].configure(*(), **{'color': 'yellow', 'cast': True, 'shape': 'circle'})
            mul_4.outputPortByName['result'].configure(*(), **{'color': 'white', 'shape': 'diamond'})
            mul_4.inputPortByName['operation'].widget.set("mul", run=False)
            mul_4.inputPortByName['applyToElements'].widget.set(1, run=False)
            mul_4.configure(*(), **{'expanded': False})
        except:
        ...
        try:
            ...
            Offset_5.inputPortByName['dial'].configure(*(), **{'color': 'green', 'cast': True, 'shape': 'circle'})
            Offset_5.inputPortByName['mini'].configure(*(), **{'color': 'green', 'cast': True, 'shape': 'circle'})
            Offset_5.inputPortByName['maxi'].configure(*(), **{'color': 'green', 'cast': True, 'shape': 'circle'})
            Offset_5.outputPortByName['value'].configure(*(), **{'color': 'green', 'shape': 'circle'})
        ...
        try:
            ...
            add_6.inputPortByName['data1'].configure(*(), **{'datatype': 'coordinates3D', 'cast': True, 'shape': 'rect', 'color': 'green'})
            add_6.inputPortByName['data2'].configure(*(), **{'color': 'white', 'cast': True, 'shape': 'diamond'})
            add_6.inputPortByName['operation'].configure(*(), **{'color': 'white', 'cast': True, 'shape': 'diamond'})
            add_6.inputPortByName['applyToElements'].configure(*(), **{'color': 'yellow', 'cast': True, 'shape': 'circle'})
            add_6.outputPortByName['result'].configure(*(), **{'color': 'white', 'shape': 'diamond'})
            add_6.inputPortByName['operation'].widget.set("add", run=False)
            add_6.inputPortByName['applyToElements'].widget.set(1, run=False)
            add_6.configure(*(), **{'expanded': False})
        except:
        ...
        try:
            ...
            triInterp_7.inputPortByName['grid'].configure(*(), **{'color': '#995699', 'cast': True, 'shape': 'diamond'})
            triInterp_7.inputPortByName['points'].configure(*(), **{'datatype': 'list', 'cast': True, 'shape': 'oval', 'color': 'cyan'})
            triInterp_7.outputPortByName['data'].configure(*(), **{'color': 'cyan', 'shape': 'oval'})
        except:
        ...
        try:
            ...
            Color_Map_9.inputPortByName['colorMap'].configure(*(), **{'color': 'magenta', 'cast': True, 'shape': 'rect'})
            Color_Map_9.inputPortByName['values'].configure(*(), **{'color': 'cyan', 'cast': True, 'shape': 'oval'})
            Color_Map_9.inputPortByName['mini'].configure(*(), **{'color': 'green', 'cast': True, 'shape': 'circle'})
            Color_Map_9.inputPortByName['maxi'].configure(*(), **{'color': 'green', 'cast': True, 'shape': 'circle'})
            Color_Map_9.inputPortByName['filename'].configure(*(), **{'color': 'white', 'cast': True, 'shape': 'oval'})
            Color_Map_9.outputPortByName['mappedColors'].configure(*(), **{'color': 'orange', 'shape': 'rect'})
            Color_Map_9.outputPortByName['colorMap'].configure(*(), **{'color': 'magenta', 'shape': 'rect'})
            Color_Map_9.outputPortByName['legend'].configure(*(), **{'color': 'red', 'shape': 'rect'})
        ...
        try:
            ...
            call_method_10.inputPortByName['objects'].configure(*(), **{'datatype': 'geom', 'cast': True, 'shape': 'rect', 'color': 'red'})
            call_method_10.inputPortByName['signature'].configure(*(), **{'color': 'white', 'cast': True, 'shape': 'oval'})
            call_method_10.addInputPort(*(), **{'name': 'materials', 'cast': True, 'datatype': 'colorfloat3or4(0)', 'required': False, 'height': 8, 'width': 12, 'shape': 'rect', 'color': 'orange'})
            call_method_10.addInputPort(*(), **{'name': 'inheritMaterial', 'cast': True, 'datatype': 'int', 'required': False, 'height': 12, 'width': 12, 'shape': 'circle', 'color': 'yellow'})
            call_method_10.outputPortByName['objects'].configure(*(), **{'color': 'white', 'shape': 'diamond'})
            call_method_10.outputPortByName['results'].configure(*(), **{'color': 'white', 'shape': 'diamond'})
        ...
        try:
            ...
            Checkbutton_11.inputPortByName['button'].configure(*(), **{'color': 'yellow', 'cast': True, 'shape': 'circle'})
            Checkbutton_11.outputPortByName['value'].configure(*(), **{'color': 'yellow', 'shape': 'circle'})
        except:
        ...
        try:
            ...
            Redraw_12.inputPortByName['viewer'].configure(*(), **{'color': 'yellow', 'cast': True, 'shape': 'rect'})
            Redraw_12.inputPortByName['trigger'].configure(*(), **{'color': 'white', 'cast': True, 'shape': 'diamond'})
        except:
        ...
        try:
            ...
            neg_13.inputPortByName['data'].configure(*(), **{'color': 'white', 'cast': True, 'shape': 'diamond'})
            neg_13.inputPortByName['operation'].configure(*(), **{'color': 'white', 'cast': True, 'shape': 'diamond'})
            neg_13.inputPortByName['applyToElements'].configure(*(), **{'color': 'yellow', 'cast': True, 'shape': 'circle'})
            neg_13.outputPortByName['result'].configure(*(), **{'color': 'white', 'shape': 'diamond'})
            neg_13.inputPortByName['operation'].widget.set("neg", run=False)
            neg_13.configure(*(), **{'expanded': False})
        except:
        ...
        try:
            ...
            Get_viewer_14.inputPortByName['objects'].configure(*(), **{'color': 'white', 'cast': True, 'shape': 'diamond'})
            Get_viewer_14.inputPortByName['attr'].configure(*(), **{'color': 'white', 'cast': True, 'shape': 'oval'})
            Get_viewer_14.outputPortByName['attrs'].configure(*(), **{'color': 'cyan', 'shape': 'oval'})
            Get_viewer_14.inputPortByName['attr'].widget.configure(*(), **{'choices': ('viewer',)})
        ...
        try:
            ...
            Slice_Data_15.inputPortByName['data'].configure(*(), **{'datatype': 'list', 'cast': True, 'shape': 'oval', 'color': 'cyan'})
            Slice_Data_15.inputPortByName['_slice'].configure(*(), **{'color': 'white', 'cast': True, 'shape': 'diamond'})
            Slice_Data_15.outputPortByName['data'].configure(*(), **{'color': 'white', 'shape': 'diamond'})
        ...
        try:
            ...
            stddev_16.inputPortByName['values'].configure(*(), **{'color': 'cyan', 'cast': True, 'shape': 'oval'})
            stddev_16.outputPortByName['stddev'].configure(*(), **{'color': 'green', 'shape': 'circle'})
        except:
        ...
        try:
            ...
            Dial_17.inputPortByName['dial'].configure(*(), **{'color': 'green', 'cast': True, 'shape': 'circle'})
            Dial_17.inputPortByName['mini'].configure(*(), **{'color': 'green', 'cast': True, 'shape': 'circle'})
            Dial_17.inputPortByName['maxi'].configure(*(), **{'color': 'green', 'cast': True, 'shape': 'circle'})
            Dial_17.outputPortByName['value'].configure(*(), **{'color': 'green', 'shape': 'circle'})
        ...
        try:
            ...
            mul_18.inputPortByName['data1'].configure(*(), **{'datatype': 'float', 'cast': True, 'shape': 'circle', 'color': 'green'})
            mul_18.inputPortByName['data2'].configure(*(), **{'datatype': 'float', 'cast': True, 'shape': 'circle', 'color': 'green'})
            mul_18.inputPortByName['operation'].configure(*(), **{'color': 'white', 'cast': True, 'shape': 'diamond'})
            mul_18.inputPortByName['applyToElements'].configure(*(), **{'color': 'yellow', 'cast': True, 'shape': 'circle'})
            mul_18.outputPortByName['result'].configure(*(), **{'color': 'white', 'shape': 'diamond'})
            mul_18.inputPortByName['operation'].widget.set("mul", run=False)
            mul_18.configure(*(), **{'expanded': False})
        except:
            print("WARNING: failed to restore Operator2 named mul in network self.macroNetwork")
            print_exc()
            mul_18=None
