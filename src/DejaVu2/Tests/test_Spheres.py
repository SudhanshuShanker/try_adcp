...
#
#
# $Id: test_Spheres.py,v 1.1.1.1.4.1 2017/07/13 22:24:00 annao Exp $
#
#
...
from DejaVu2.Spheres import Spheres,TriangulateIcos,TriangulateIcosByEdgeCenterPoint
...
class Spheres_Viewer_Tests(unittest.TestCase):
    """
tests for Spheres in DejaVu2.Viewer
    """
...
#one test of setting properties via DejaVu2GuiSpheres
