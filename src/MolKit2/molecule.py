...
After running this command, atoms will have:
   ...
   - HB donor acceptor properties ('hbType')
    ...
    def setBondorder(self, bondOrder, obmol=None):
        ...
        if 'lines' in self._renderingProp:
    ...
    def setDoubleBondSep(self, value):
        assert isinstance(value, Real), "ERROR: double bond separation has to be afloating point value, got%g"%value
    ...
    def setTripleBondSep(self, value):
        assert isinstance(value, Real), "ERROR: triple bond separation has to be afloating point value, got%g"%value
