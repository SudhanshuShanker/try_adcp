...
class GridGUITest(unittest.TestCase):
    ...
    def test_loadReceptorPDB(self):
        ...
        misatkeys = list(self.app.PDBprofile._missingAtoms.keys())
        assert set(misatkeys) == set(
            ['B:SER:10:_', 'A:LYS:257:_', 'A:ALA:406:_', 'A:ARG:384:_',
             ...
             'A:LYS:402:_'])
        mutateKeys = list(self.app.PDBprofile._resToMutate.keys())
        ...
        tree = list(self.app.analyserWidget.treeWidgets.values())[0].treeWidget
        ...
        recItemTree = list(self.app.analyserWidget.treeWidgets.values())[0]
