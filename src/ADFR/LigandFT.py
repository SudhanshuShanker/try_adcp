...
class LigandFT:
    ...
    def __init__(self, mol, torTree, transPoints=None, covalentLigandAnchorAtoms=False, fixedRoot=False, neighborSearchCutoff=-1.0, useRama=True):
        ...
        if covalentLigandAnchorAtoms:
            ...
            #print 'IND4', rat1Ind
            atomSetStatic.setScorablePairwise(int(rat1Ind), False) # N not pairwise
        ...
        def _handleChild(torTree, ttchild, ftParent):
            ...
            print('TOR_lig', na, nb, nc, nd, ttchild.distanceFromLeaf, end=' ')
                ...
                if self.mol._ag[b].getResname()=='PRO':
                    ...
                    if _isphi:
                        if sw1:
                            ...
                            print('RamaMODPhi', na, nb, nc, nd, end=' ')
                        if sw2:
                            d = sw2[1]
                        ...
                        if _ispsi:
                            if sw1:
                                a = sw1[1]
                                na = self.mol._ag[a].getName()
                                print('RamaMODPsi', na, nb, nc, nd, end=' ')
                            if sw2:
                                d = sw2[1]
                                nd = self.mol._ag[d].getName()
                                print('RamaMODPsi', na, nb, nc, nd, end=' ')
        ...
        if self.useRama:
            ...
            if len(phi) and len(psi):
                ...
                for k, v in list(residues.items()):
