...
class ExtrudeSSElt(ExtrudeObject):
    ...
    def __init__(self, ssElt, shape, gapEnd = 0, gapBeg = 0, cap1=0,
        ...
        self.residuesInChain.nbSS = list(range(len(self.residuesInChain)))
